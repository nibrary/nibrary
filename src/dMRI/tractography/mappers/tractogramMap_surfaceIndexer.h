...
namespace NIBR
{
    ...
    std::vector<std::unordered_map<int,float>> index2surface(std::shared_ptr<NIBR::TractogramReader> tractogram, Surface& surf, float sigma);
    
    void index2surface(std::shared_ptr<NIBR::TractogramReader> tractogram, Surface& surf, float sigma, std::string indexFilePrefix);
    ...
    std::vector<std::unordered_map<int,float>> readSurfaceIndexing(std::shared_ptr<NIBR::TractogramReader> tractogram, std::string& indexFilePrefix);
