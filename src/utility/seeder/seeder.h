...
public:
	...
	virtual bool setSeed(Point3D xyz, float r) = 0;
	virtual bool setSeed(float* p,  float r) = 0;

    // List
    virtual bool setSeed(std::vector<Point3D>& p) = 0;
	virtual bool setSeed(std::vector<Point3D>& p, std::vector<Point3D>& dir) = 0;
